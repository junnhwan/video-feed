...
import type { GetAllFollowersResponse, GetAllVloggersResponse, MessageResponse, SocialCountsResponse } from './types'
...
export function getCounts() {
  return postJson<SocialCountsResponse>('/social/getCounts', {}, { authRequired: true })
}
